      ...
      <div>
        <List>
          <CopyToClipboard
            text={FTPHost}
            onCopy={() =>
              this.props.copyNotify(t('common:alreadyCopy'), 'ftpHost')}
          >
            <ListItem
          ...
          <CopyToClipboard
            text={FTPPort}
            onCopy={() =>
              this.props.copyNotify(t('common:alreadyCopy'), 'ftpPort')}
          >
            <ListItem
          ...
          <CopyToClipboard
            text={'FTP'}
            onCopy={() =>
              this.props.copyNotify(t('common:alreadyCopy'), 'ftpProtocol')}
          >
            <ListItem
          ...
          <CopyToClipboard
            text={username}
            onCopy={() =>
              this.props.copyNotify(t('common:alreadyCopy'), 'ftpAccount')}
          >
            <ListItem
          ...
          <CopyToClipboard
            text={pass}
            onCopy={() =>
              this.props.copyNotify(t('common:alreadyCopy'), 'ftpPassword')}
          >
            <ListItem
